...
| TS010 | V4.4 reference-free both-valid candidate-diversity audit | DONE_GATE_PASS | 126 nonzero training pairs; 41 rescue and 85 reverse; public-schema-valid unranked alternatives with exact snapshots and no protected outcomes in training prompts |
| TS011 | V4.5 matched anchored learner | DONE_NEGATIVE_CONFIRMATION | Development +0.83 accuracy points, but frozen confirmation -2.44 points with 1 win/4 losses; both Rescue and Reverse margins shifted toward A, exposing an anti-B shortcut |
| TS012 | V4.6 selective causal residual learner | DONE_NEGATIVE_SAFE_NO_GAIN | Routed 62/126 unique events to correction and 64/126 to retention; development exactly tied Mask at 65.29% with 1 win/1 loss, while Reverse margin moved the wrong way; post-hoc restored V4.5 to Mask but did not beat it |
| TS013 | V5 independent KEEP/FLIP causal router | READY_CLOUD | Freeze base and Mask; train task-grouped margin-only and semantic logistic heads from public frozen representations; threshold selected by train-only OOF; known V4.5 sets remain development/post-hoc |
