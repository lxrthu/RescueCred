...
| TS012 | V4.6 selective causal residual learner | READY_CLOUD | Common frozen Mask start; correct only weak/wrong signed margins and retain already-correct margins; matched continued-B control; known V4.5 sets are development/post-hoc only |
