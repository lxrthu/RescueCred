...
| TS009 | V4.3 multi-prefix anchored Mask vs causal preference seed 42 | READY_CLOUD | Reuses only offset-85 training tasks, up to 4 visible-prefix events/task; data gate >=60 nonzero, >=8 reverse from >=5 tasks; matched 180-presentation anchored learner; offset-125 dev gate before frozen offset-165 confirmation; final 13 scenarios reserved |
